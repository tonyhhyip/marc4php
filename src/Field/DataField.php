 ...
 * and zero or more subfields represented by {@link Subfield} objects.
...
final class DataField extends Field
{
	 ...
	 * of subfields.
	 *
	 * @param Subfield $new_subfield The subfield to add
	 *
	 * @return Subfield  the new File_MARC_Subfield object
	 */
	public function appendSubfield(Subfield $new_subfield)
	{
	 ...
	 *
	 * Adds a Subfield object to the  start of the existing list
	 * of subfields.
	 *
	 * @param Subfield $new_subfield The subfield to add
	 *
	 * @return Subfield the new Subfield object
	 */
	public function prependSubfield(Subfield $new_subfield)
	{
		$pos = 0;
	 ...
	 *
	 * Inserts a {@link Subfield} object before or after an existing
	 * subfield.
	 *
	 * @param Subfield $new_field      The subfield to add
	 * @param Subfield $existing_field The target subfield
	 * @param bool               $before         Insert the subfield before the existing subfield if true; after the existing subfield if false
	 *
	 * @return Subfield              The new subfield
	 */
	public function insertSubfield(Subfield $new_field, Subfield  $existing_field, $before = false)
	{
	 ...
	 *
	 * @param array $subfields array of {@link Subfield} objects
	 *
	...
	{
		/*
		 * Just in case someone passes in a single Subfield
		 * instead of an array
		 */
		if ($subfields instanceof Subfield) {
	 ...
	 *
	 * @param Subfield $subfield The subfield to delete.
	 */
	public function deleteSubfield(Subfield $subfield)
	{
	 ...
	 * {@link Subfield} is retrieved
	 *
	 * @return Subfield returns the first subfield that matches
